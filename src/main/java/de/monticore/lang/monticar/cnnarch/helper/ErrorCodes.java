...
public class ErrorCodes {
    ...
    public static final String UNKNOWN_METHOD_CODE = "x33585";
    public static final String ILLEGAL_NAME_CODE = "x93567";
    public static final String UNKNOWN_ARGUMENT_CODE = "x92527";
    public static final String DUPLICATED_NAME_CODE = "x91569";
